package com.quicksolveplus.covid.covid_tracking.vaccination.adapter
...
class VaccinationSupportDocAdapter(
    private val context: Context,
    private val covidList: ArrayList<String>,
    private val viewModel: CovidViewModel,
    val supportDocActions: (position: Int) -> Unit
) : RecyclerView.Adapter<VaccinationSupportDocAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val binding: LayoutItemSupportDocBinding) :
        ...
        fun requestImageFile(body: JsonObject) {
            viewModel.getImageFile(body, Pair(adapterPosition, covidList[adapterPosition]))
        }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (file.exists()) {
            ...
            holder.binding.ivSupportDoc.loadGlide(file,ContextCompat.getDrawable(holder.context, R.drawable.ic_avatar))
        } else {
